...
## Environment Setup (AiSensy WhatsApp Integration)

Add the following variables to your `.env.local` to enable outbound WhatsApp notifications:

```env
AISENSY_PROJECT_API_KEY=your_project_api_password
