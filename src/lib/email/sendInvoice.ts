  ...
  const htmlTemplate = `
    ...
    <body>
      <div class="container">
        ...
        <!-- FOOTER -->
        <div class="footer">
          <p style="margin: 0 0 8px 0; font-weight: 600; color: #E5E7EB;">Thank you for choosing Mehta Sweet Mart.</p>
          <p style="margin: 0 0 20px 0;">Serving Premium Sweets Since 1972.</p>
          <p style="margin: 0; font-size: 11px; color: #6B7280;">Taleti Rd, Navagadh, Palitana, Gujarat - 364270</p>
          <p style="margin: 8px 0 0 0; font-size: 11px; color: #6B7280;">© ${new Date().getFullYear()} Mehta Sweet Mart. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
