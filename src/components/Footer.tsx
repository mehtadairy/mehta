...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#4A2F1F] border-t border-[#4B2F1F]/20 text-white overflow-hidden">


      {/* Upper Footer: Premium dark brown background */}
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      {/* Bottom Footer: Darker brown */}
      <div className="bg-[#3D2518] text-white pt-6 pb-20 border-t border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="h-8 w-8 rounded bg-[#5C3E2F] hover:bg-[#4A2F1F] flex items-center justify-center text-white transition-colors cursor-pointer border border-[#4B2F1F]"
