      ...
      {isVisible && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center z-10">
            {/* Official 3D Metallic Gold Logo Badge (Mehta Dairy) */}
            <motion.div
            ...
            >
              <img
                src="/logo.png"
                alt="Mehta Dairy"
                className="h-28 sm:h-36 md:h-44 max-w-[85vw] w-auto object-contain drop-shadow-[0_12px_30px_rgba(200,155,60,0.35)]"
              />
            </motion.div>
