  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        customer_address: customer.address || "Address Not Provided",
            ...
            <section className="bg-white p-5 rounded-xl border border-brand-beige shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <input type="text" value={customer.address} onChange={e => setCustomer({...customer, address: e.target.value})} className="w-full text-sm border-brand-beige rounded-lg focus:ring-brand-orange focus:border-brand-orange px-3 py-2 border" placeholder="Full address" />
                </div>
              </div>
            </section>
