        ...
        <div className="a4-container">
          ...
          <div className="flex justify-between gap-6 mb-6">
            ...
            <div className="w-1/2 p-3 bg-brandLight border border-borderSoft rounded-md">
              ...
              <p className="font-bold text-[13px] text-brandDark mb-1">Mehta Sweet Mart</p>
              <div className="text-textMuted flex flex-col gap-0.5">
                <p>Taleti Rd, Navagadh</p>
                <p>Palitana, Gujarat - 364270</p>
                <p className="font-bold mt-1 text-textMain">GSTIN: 24ACKPM9230A2ZW</p>
