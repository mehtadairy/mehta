...
export const SellerCard = () => (
  <View style={localStyles.card}>
    ...
    <Text style={[globalStyles.cardValue, { color: '#b45309', fontSize: 11 }]}>Mehta Sweet Mart</Text>
    
    <View style={{ marginTop: 2 }}>
      <Text style={globalStyles.cardLabel}>Taleti Rd, Navagadh,</Text>
      <Text style={globalStyles.cardLabel}>Palitana, Gujarat - 364270</Text>
      <Text style={[globalStyles.cardLabel, { color: COLORS.textDark, fontWeight: 'bold', marginTop: 1 }]}>GSTIN: 24ACKPM9230A2ZW</Text>
    </View>
    ...
    <View style={[localStyles.iconRow, { marginTop: 2 }]}>
      ...
      <Text style={[globalStyles.cardLabel, { marginBottom: 0, color: COLORS.textDark }]}>www.mehtasweetmart.com</Text>
    </View>
    ...
    <View style={[localStyles.iconRow, { marginTop: 2 }]}>
      ...
      <Text style={[globalStyles.cardLabel, { marginBottom: 0, color: COLORS.textDark }]}>support@mehtasweetmart.com</Text>
    </View>
  </View>
);
