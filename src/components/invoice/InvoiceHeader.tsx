...
export const InvoiceHeader = ({ invoiceNo, orderNo, date, logo }: InvoiceHeaderProps) => (
  <View style={localStyles.headerContainer}>
    ...
    <View style={localStyles.logoContainer}>
      {logo ? <Image style={localStyles.logo} src={logo} /> : <Text style={localStyles.fallbackLogoText}>Mehta Sweet Mart</Text>}
      <Text style={{ fontSize: 7, color: '#b45309', fontWeight: 'bold', marginTop: 2, letterSpacing: 0.5 }}>SINCE 1972</Text>
    </View>
