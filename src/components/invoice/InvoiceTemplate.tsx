  ...
  return (
    <Document>
      <Page size="A4" style={globalStyles.page}>
        ...
        <View style={[globalStyles.row, globalStyles.spaceBetween, globalStyles.container, { marginBottom: 12 }]}>
          <SellerCard />
        ...
        <View style={[globalStyles.row, globalStyles.spaceBetween, globalStyles.container, { marginTop: 12 }]} wrap={false}>
          <PaymentCard 
