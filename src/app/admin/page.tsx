                                    ...
                                    return (
                                        <div key={item.id} className="relative group flex items-center">
                                            <button
                                                type="button"
                                                onClick={() => setActiveTab(item.id as any)}
                                                className={`w-full text-left text-xs font-bold px-3 py-2.5 rounded-xl flex items-center transition-colors relative z-10 ${isActive
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-brand-cream/20 p-4 rounded-xl border border-brand-beige">
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5 border border-brand-beige bg-white p-1 rounded-lg">
                                                        <button
                                                            ...
                                                            className={`px-3 py-1.5 text-[0.68rem] font-bold rounded-md uppercase tracking-wider transition-colors ${prodSubTab === "all"
                                                        ...
                                                        {categories.map(cat => (
                                                            <button
                                                                ...
                                                                className={`px-3 py-1.5 text-[0.68rem] font-bold rounded-md uppercase tracking-wider transition-colors ${prodSubTab === cat.slug
                                                                        ? "bg-brand-orange text-white"
                                                                        : "text-brand-charcoal hover:bg-brand-cream"
                                                                    }`}
                                                            >
                                                ...
                                                {(["All", "Processing", "Shipped", "Delivered", "Cancelled"] as const).map((status) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`px-3 py-1.5 text-[0.68rem] font-bold rounded-md uppercase tracking-wider transition-colors ${orderStatusFilter === status
                                                                    ? "bg-brand-orange text-white"
                                                                    : "text-brand-charcoal hover:bg-brand-cream"
                                                                }`}
                                                        >
