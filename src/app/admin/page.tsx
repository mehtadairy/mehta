...
const AdminCategories = dynamic(() => import("@/components/AdminCategories"), { ssr: false });
const AdminBanners = dynamic(() => import("@/components/AdminBanners"), { ssr: false });
const AdminNotifications = dynamic(() => import("@/components/AdminNotifications"), { ssr: false });
const AdminPayments = dynamic(() => import("@/components/AdminPayments"), { ssr: false });
const AdminRecovery = dynamic(() => import("@/components/AdminRecovery"), { ssr: false });
            ...
            if (res.ok) {
              ...
              if (data.orders) {
                  const formattedOrders = data.orders.map((o: any) => ({
                      ...
                      source: String(o.source || (o.shipping_address && typeof o.shipping_address === 'object' && o.shipping_address.source ? o.shipping_address.source : 'website') || 'website').toLowerCase(),
