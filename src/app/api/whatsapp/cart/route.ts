...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.log("[CartAPI] === INCOMING REQUEST BODY ===");
    ...
    if (customerErr) {
      console.error('[CartAPI] Customer lookup database error:', customerErr);
      return NextResponse.json({
        success: false,
    ...
    console.log('--- WhatsApp Cart API Logs ---');
    ...
    console.error('API WhatsApp Cart Error:', error);
    return NextResponse.json({
      success: false,
