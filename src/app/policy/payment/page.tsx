          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              >
                ...
                <div className="border border-brand-beige/60 bg-brand-cream/5 rounded-2xl p-5 text-xs text-brand-charcoal font-semibold text-center leading-relaxed shadow-3xs">
                  Contact customer care at <a href={`tel:${BUSINESS.phoneTel}`} className="text-brand-orange font-bold hover:underline">{BUSINESS.phone}</a> for direct bank transfers.
                </div>
              </motion.div>
